...
The recorded validation used this pip/uv alternative. From the repository root,
choose an environment path:
...
ignored by Git. The [archived report bundles](https://github.com/AlexanderFengler/baygent-skills/tree/b5d6d0702f3f0d8dc73d5a6247b733dc79c60131/evals/bambi-workflow/iteration-1/runtime/calibration-reassessment/)
and historical HTML exports are linked from the
[validation record](../../evals/bambi-workflow/iteration-1/README.md).
Raw NetCDF files were not committed.

## Validation and limits

```bash
python -m pytest evals/smoke/test_bambi_workflow.py evals/smoke/test_bambi_reporting.py
...
The recorded full fits pass both raw-PIT and coverage-transformed PPC-PIT tests.
The survey retains strong prior sensitivity for the regional standard deviation;
its next modeling step is a justified alternate regional-scale prior and a
comparison of the requested probability. These fitted-data checks do not
establish held-out calibration, and synthetic data do not justify priors for a
real survey. The survey report uses replicated support proportions and regional
intervals. Both reports preserve the shared section structure and assessments.
